...
<div class="col-md-12">
  <H2 class="text-white pb-5" id="contact">About Us</H2>
</div>
</div>
  ...
  <div class="row">
    <div class="col-md-6">
      <div class="my-3 mx-5">
        ...
        <div class="text-secondary fs-5  mb-5">When a child gets access to good food, it can change just about everything. Sed do eiusmod tempor incididunt dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation</div>
        <a href="#">
          <div class="btn btn-lg rounded-0 px-5 py-3" id="btnback">Discover more</div>
        </a>
      </div>
    </div>
    <div class="col-md-6 position-relative">
      <!--pamplates pending -->
      <img src="img/charity/pamplate full.webp" height="580" width="90%" class="mb-4" />
    </div>


    <div class="container-fluid mt-5" id="bg">
...
<div class="row container-fluid">
  <div class="col-md-6 ">
    <img src="img/charity/aboutus.webp" height="580" width="90%" id="img3">
  </div>
  <div class="col-md-5 px-5" id="text">
